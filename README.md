...
当前包含 140 项自动化测试，覆盖确定性规则内核、AgentScope 决策和混合单日局，以及 EvidenceLedger、确定性映射、规则推导、严格公共 Claim、逐 Claim 容错解析、失败回归样本、紧凑 EvidenceContext、本地 Evidence 引用审计、批量缓存、ID 隔离和失败降级。
